...
def main():
    ...
    if args.stage == "A":
        ...
        output_dir = os.path.join(default_models, "patent_ape_stageA")
        ...
        stage_a_dir = os.path.join(default_models, "patent_ape_stageA", "final")
        output_dir = os.path.join(default_models, "patent_ape_stageB")
        mt_column = "mt_deepl"
