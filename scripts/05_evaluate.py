...
Usage:
    ...
    python 05_evaluate.py --model "C:\glosswerk\models\patent_ape_stageA\final"

    # Evaluate Stage B model (DeepL fine-tuned):
    python 05_evaluate.py --model "C:\glosswerk\models\patent_ape_stageB\final"

    # Quick test with fewer samples:
    python 05_evaluate.py --model "C:\glosswerk\models\patent_ape_stageA\final" --limit 200
"""
