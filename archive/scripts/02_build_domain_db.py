...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default=r"C:\glosswerk\data\raw")
    parser.add_argument("--output_db", type=str, default=None,
                        help="Output DB path (default: C:\\glosswerk\\data\\glosswerk_{domain}.db)")
    ...
    if not args.output_db:
        args.output_db = rf"C:\glosswerk\data\glosswerk_{args.domain}.db"
